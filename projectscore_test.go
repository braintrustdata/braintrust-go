...
func TestProjectScoreNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ProjectScores.New(context.TODO(), braintrust.ProjectScoreNewParams{
		...
		Categories: braintrust.F[braintrust.ProjectScoreNewParamsCategoriesUnion](braintrust.ProjectScoreNewParamsCategoriesProjectScoreCategoryInfoData0([]braintrust.ProjectScoreCategoryParam{{
			Name:  braintrust.F("name"),
...
func TestProjectScoreUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ProjectScores.Update(
		...
		braintrust.ProjectScoreUpdateParams{
			Categories: braintrust.F[braintrust.ProjectScoreUpdateParamsCategoriesUnion](braintrust.ProjectScoreUpdateParamsCategoriesProjectScoreCategoryInfoData0([]braintrust.ProjectScoreCategoryParam{{
				Name:  braintrust.F("name"),
				Value: braintrust.F(0.000000),
			}, {
				Name:  braintrust.F("name"),
...
func TestProjectScoreReplaceWithOptionalParams(t *testing.T) {
	...
	_, err := client.ProjectScores.Replace(context.TODO(), braintrust.ProjectScoreReplaceParams{
		...
		Categories: braintrust.F[braintrust.ProjectScoreReplaceParamsCategoriesUnion](braintrust.ProjectScoreReplaceParamsCategoriesProjectScoreCategoryInfoData0([]braintrust.ProjectScoreCategoryParam{{
			Name:  braintrust.F("name"),
			Value: braintrust.F(0.000000),
		}, {
			Name:  braintrust.F("name"),
