...
```sh
go get -u 'github.com/braintrustdata/braintrust-go@v0.4.0'
```
...
We also provide a helper `braintrust.FileParam(reader io.Reader, filename string, contentType string)`
