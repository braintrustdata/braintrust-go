...
func TestProjectUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Projects.Update(
		...
		braintrust.ProjectUpdateParams{
			...
			Settings: shared.ProjectSettingsParam{
				BaselineExperimentID: braintrust.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
				ComparisonKey:        braintrust.String("comparison_key"),
				SpanFieldOrder: []shared.ProjectSettingsSpanFieldOrderParam{{
					ColumnID:   "column_id",
					ObjectType: "object_type",
					Position:   "position",
					Layout:     shared.ProjectSettingsSpanFieldOrderLayoutFull,
				}},
			},
		},
	)
...
func TestProjectListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Projects.List(context.TODO(), braintrust.ProjectListParams{
		...
		IDs: braintrust.ProjectListParamsIDsUnion{
